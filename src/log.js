...
export function insert(entry) {
    tableModel.addRow([new Date(entry.time).toLocaleString(), entry.level, entry.msg]);
...
export function createLogWindow() {
    ...
    win.value.setContentSize({ width: 580, height: 380 });
    ...
    table.addColumnWithOptions('Type', { column: 1, width: 60 });
